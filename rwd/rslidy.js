...
var PrintSettingsComponent = /** @class */ (function () {
    function PrintSettingsComponent() {
        ...
        window.rslidy.utils.setInputFilter(document.getElementById("rslidy-margin-input"), function (value) { return /^\d*[.,]?\d*$/.test(value); });
    ...
    PrintSettingsComponent.prototype.applyPrintSettings = function () {
        ...
        var margin = (this.view.querySelector("#rslidy-margin-input"));
        var css = "@media print {\n";
        if (!link.checked) {
    ...
    PrintSettingsComponent.prototype.loadSettings = function () {
        ...
        this.view.querySelector("#rslidy-margin-input").value = data.margin;
        this.applyPrintSettings();
    };
    // ---
    ...
    PrintSettingsComponent.prototype.generateJSON = function () {
        var me = (this.view.querySelector("#rslidy-margin-input"));
        var m = "10";
...
var ContentComponent = /** @class */ (function () {
    function ContentComponent(view) {
        ...
        this.view.addEventListener("mousedown", function (e) {
            ...
            _this.marginTap(e, function () { _this.marginTabLeftDown = true; }, function () { _this.marginTabRightDown = true; }, function () {
                _this.marginTabLeftDown = false;
                _this.marginTabRightDown = false;
            });
        });
        this.view.addEventListener("mouseup", function (e) {
            _this.marginTap(e, function () {
                if (_this.marginTabLeftDown)
                    _this.navPrevious(true);
                _this.marginTabLeftDown = false;
            }, function () {
                if (_this.marginTabRightDown)
                    _this.navNext(true);
                _this.marginTabRightDown = false;
            }, function () { });
    ...
    ContentComponent.prototype.showSlide = function (targetSlideIndex, animate) {
        ...
        var slide_index_one_indexed = window.rslidy.utils.toInt(targetSlideIndex) + 1;
        window.location.href =
            url_parts[0] + "#" + slide_index_one_indexed;
        // Update slide caption
        this.slide_caption.innerHTML = " /" + window.rslidy.num_slides;
        this.slide_input.value = "" + slide_index_one_indexed;
        this.currentSlideIndex = targetSlideIndex;
    };
    // ---
